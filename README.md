...
- [x] What steps can you take in your web apps to keep your data secure?
  ...
  2- Use HTTPS.
  3- Implement JWT to every user.
  4- Requiring sign on for sensitive data

- [x] Describe how web servers work.

  Server responds to requests from the front end and send data back if it matches the end points.
